...
class IfaController extends Template {
	...
	public function index() {
        ...
        ,'c.nombre as caracter','a.nombre as accion','audi.clave','sia_Volantes.extemporaneo','t.idEstadoTurnado')
        	...
        	echo $this->render('/Oficios/Ifa/index.twig',[
            'iracs' => $iracs,
            'sesiones'=> $_SESSION,
            'modulo' => 'Irac',
            'filejs' => $this->filejs
        ...
        echo $this->render('Oficios/Ifa/create.twig',[
            'sesiones' => $_SESSION,
            'modulo' => $this->modulo,
            'mensaje' => $message,
            'errors' => $errors,
    ...
    public function save_turnado(array $data,$file, $app) {
        ...
        if(empty($validate)){
            ...
            BaseController::send_notificaciones($data,$datos,'Ifa');
            BaseController::send_notificaciones_varios($data,$datos,'Ifa');
    ...
    public function createDocumentos($id,$message, $errors) {
        $turnados = $this->load_personal($id);
         ...
         echo $this->render('Oficios/Ifa/documentos.twig',[
            'sesiones' => $_SESSION,
            'modulo' => $this->modulo,
            'mensaje' => $message,
            'errors' => $errors,
