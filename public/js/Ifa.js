...
module.exports = (__webpack_require__(64))(0);
...
module.exports = (__webpack_require__(64))(7);
...
var modal = __webpack_require__(334);
var m = new modal();
...
module.exports = function () {
    ...
    _createClass(Base, [{
        ...
        key: 'load_date_inputs',
        value: function load_date_inputs() {
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return this.send_data_insert_without_file(datos, ruta);
        ...
        value: function () {
            ...
            function new_insert_with_file(_x5, _x6) {
        ...
        key: 'send_data_insert_without_file',
        value: function send_data_insert_without_file(datos, ruta) {
        ...
        key: 'new_update',
        value: function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(datos, ruta) {
                var res, table;
...
module.exports = (__webpack_require__(64))(2);
...
( function( factory ) {
	if ( true ) {
		...
		// AMD. Register as an anonymous module.
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(46), __webpack_require__(127) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else {
...
module.exports = function () {
    ...
    _createClass(_class, [{
        ...
        key: 'textos_promocion_cedula_ifa',
        value: function textos_promocion_cedula_ifa(html) {
...
var irac = __webpack_require__(375);
...
var modals = __webpack_require__(337);
var m = new modals();
...
module.exports = function () {
    ...
    _createClass(_class, [{
        key: 'load_update_form_observaciones',
        value: function load_update_form_observaciones() {
        ...
        value: function validate_insert_observaciones() {
            ...
            $('form#Observaciones-insert').validate({
                ...
                submitHandler: function submitHandler(form) {
                    ...
                    var formData = $('form#Observaciones-insert').serializeArray();
        ...
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(datos, ruta, idVolante) {
                var res, table;
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
            ...
            function new_insert_observacion(_x, _x2, _x3) {
                return _ref.apply(this, arguments);
            }
        ...
        value: function validate_update_observaciones() {
            ...
            $('form#Observaciones-update').validate({
                ...
                submitHandler: function submitHandler(form) {
                    ...
                    var texto = CKEDITOR.instances['ckeditor'].getData();
                    var formData = $('form#Observaciones-update').serializeArray();
        ...
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(datos, ruta, idVolante) {
                var res, table;
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
            ...
            function new_update_observacion(_x4, _x5, _x6) {
                return _ref2.apply(this, arguments);
            }
        ...
        key: 'load_textos_cedula',
        value: function load_textos_cedula() {
        ...
        value: function () {
                ...
                return regeneratorRuntime.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                _context4.next = 2;
                                return this.load_textos_promocion();

                            case 2:
                                datos = _context4.sent;
                                table = this.construct_table_textos(datos);
            ...
            function modal_textos_promocion() {
                return _ref4.apply(this, arguments);
            }

            return modal_textos_promocion;
        }()
    }, {
        key: 'load_textos_promocion',
        value: function load_textos_promocion() {
        ...
        key: 'construct_table_textos',
        value: function construct_table_textos(datos) {
        ...
        key: 'validate_insert_cedula',
        value: function validate_insert_cedula() {
            ...
            $('form#insert-cedula-irac').validate({
                ...
                submitHandler: function submitHandler(form) {
                    ...
                    var datos = $('form#insert-cedula-irac').serializeArray();
        ...
        value: function () {
            var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(datos, ruta, idVolante) {
                var res, table;
            ...
            function new_insert_cedula(_x7, _x8, _x9) {
        ...
        key: 'validate_update_cedula',
        value: function validate_update_cedula() {
            ...
            $('form#update-cedula-irac').validate({
                ...
                submitHandler: function submitHandler(form) {
                    ...
                    var datos = $('form#update-cedula-irac').serializeArray();
        ...
        value: function () {
            ...
            function new_update_cedula(_x10, _x11, _x12) {
...
module.exports = "<table class=\"table table-hover modal-promocion-acciones\">\r\n    <thead>\r\n        <th>Seleccionar</th>\r\n        <th>Texto</th>\r\n    </thead>\r\n    <tbody>\r\n        :body:\r\n    </tbody>\r\n</table>";
