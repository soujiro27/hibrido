...
var modals = __webpack_require__(332);
...
module.exports = function () {
	...
	_createClass(Funciones, [{
		...
		value: function () {
			var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tipo, audi) {
				var response, option;
				return regeneratorRuntime.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_context.next = 2;
								return this.send_datos_subdocumentos(tipo, audi);

							case 2:
								response = _context.sent;
								option = '<option value="">Escoga una Opcion</option> ';
			...
			function construct_sub_documentos(_x, _x2) {
				return _ref.apply(this, arguments);
			}

			return construct_sub_documentos;
		}()
	}, {
				...
				return regeneratorRuntime.wrap(function _callee2$(_context2) {
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								_context2.next = 2;
								return this.send_data(datos, ruta);

							case 2:
								test = _context2.sent;

								if (test[0].campo != 'success') {
									table = this.construct_table_errors(test);
		...
		key: 'new_update',
		value: function () {
			var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(datos, ruta) {
				var res, table;
				return regeneratorRuntime.wrap(function _callee3$(_context3) {
					while (1) {
						switch (_context3.prev = _context3.next) {
							case 0:
								_context3.next = 2;
								return this.update_data(datos, ruta);
...
var funciones = __webpack_require__(126);
var volantes = __webpack_require__(333);
var diversos = __webpack_require__(337);
...
module.exports = function () {
	function Modal_validate() {
		_classCallCheck(this, Modal_validate);
	}

	_createClass(Modal_validate, [{
		key: 'errors',
		...
		key: 'order',
		value: function order(ruta, html) {
				...
				buttons: {
					confirm: {
						...
						action: function action() {
							...
							var campo = $('select#campo :selected').val();
							var tipo = $('select#tipo :selected').val();
...
var modalsVolantes = __webpack_require__(334);
var mv = new modalsVolantes();
	...
	_createClass(Volantes, [{
		...
		value: function modal_subDocumento() {
			...
			$('select#subDocumento').change(function () {
				...
				var documento = $('select#documento :selected').val();
		...
		value: function form_submit() {
			$('form#Volantes-form').validate({
				...
				submitHandler: function submitHandler(form) {
					...
					var formData = new FormData(document.getElementById('Volantes-form'));
		...
		value: function form_update() {
			$('form#Volantes-update').validate({
				...
				submitHandler: function submitHandler(form) {
					...
					var formData = $('form#Volantes-update').serializeArray();
...
module.exports = function () {
	...
	_createClass(ModalVolantes, [{
		...
		key: 'load_auditorias',
		value: function () {
			var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(numero, cuenta) {
				var response, table_auditoria, turnos, table_turnos;
				return regeneratorRuntime.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_context.next = 2;
								return this.get_datos_auditorias(numero, cuenta);
							...
							case 2:
								...
								table_auditoria = this.construct_table_datos_auditoria(response);
								_context.next = 8;
								return this.get_turnos_auditoria(numero, cuenta);

							case 8:
								turnos = _context.sent;
								table_turnos = this.construct_table_turnados_auditoria(turnos);
			...
			function load_auditorias(_x, _x2) {
				return _ref.apply(this, arguments);
			}
...
var modalsDiversos = __webpack_require__(338);
...
module.exports = function () {
	function ModalsDiversos() {
		_classCallCheck(this, ModalsDiversos);
	}

	_createClass(ModalsDiversos, [{
		key: 'remitentes',
		...
		value: function () {
			var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tipo, siglas) {
				var datos, table;
				return regeneratorRuntime.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_context.next = 2;
								return this.remitentes_volantes(tipo, siglas);

							case 2:
								datos = _context.sent;
								table = this.table_remitentes(datos);
			...
			function construct_tabla_remitentes(_x, _x2) {
				return _ref.apply(this, arguments);
			}

			return construct_tabla_remitentes;
		}()
	}, {
